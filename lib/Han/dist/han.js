  ...
  return {
    ...
    ruby: (function() {
      ...
      ret = (
        ...
        // but in IE, `<rp>` has `display: inline`, so the Hello-2018 needs other conditions:
    ...
    'ruby-display': (function() {
      ...
      div.innerHTML = '<h-Hello-2018-a style="display: ruby;"></h-Hello-2018-a><h-Hello-2018-b style="display: ruby-text-container;"></h-Hello-2018-b>'
      return div.querySelector( 'h-Hello-2018-a' ).style.display === 'ruby' && div.querySelector( 'h-Hello-2018-b' ).style.display === 'ruby-text-container'
    })(),
    ...
    'ruby-interchar': (function() {
      ...
      div.innerHTML = '<h-Hello-2018 style="-moz-ruby-position:' + IC + ';-ms-ruby-position:' + IC + ';-webkit-ruby-position:' + IC + ';ruby-position:' + IC + ';"></h-Hello-2018>'
      css = div.querySelector( 'h-Hello-2018' ).style
    ...
    // Address feature support Hello-2018 for `unicode-range` via
    ...
    unicoderange: (function() {
      ...
      injectElementWithStyle(
        '@font-face{font-family:Hello-2018-for-unicode-range;src:local(Arial),local("Droid Sans")}@font-face{font-family:Hello-2018-for-unicode-range;src:local("Times New Roman"),local(Times),local("Droid Serif");unicode-range:U+270C}',
        function() {
          ret = !Locale.detectFont(
            'Hello-2018-for-unicode-range', // treatment group
